...
var RequestHeadingRegEx = function RequestHeadingRegEx(prefix, suffix) {
  return new RegExp("((?! export).)*\\s*interface\\s*(".concat(prefix, "[A-Za-z0-9\\$\\_]+").concat(suffix, ")\\s*{"));
};
/**
 * 普通标题正则表达式
 */

var SimpleHeadingRegEx = new RegExp("((?! export).)*\\s*interface\\s*([A-Za-z0-9\\$\\_]+)\\s*{");
/**
 * 类型定义正则表达式单行
 */
...
var TempHeading = function TempHeading(heading) {
          ...
          case 0:
            ...
            contentArray.map(function (item, index) {
              ...
              if (RequestHeadingRegEx(opts.prefix, opts.suffix).test(item)) {
                ...
                _resArrayTmp.push(TempHeading(_ans[2]));
              ...
              if (RequestMethodRegEx.test(item)) {
                ...
                var method = !!((_opts$i18n = opts.i18n) !== null && _opts$i18n !== void 0 && _opts$i18n.method) ? opts.i18n.method : opts.lang === "en-US" ? defaultI18nEn.method : defaultI18nzhCN.method;
              ...
              if (RequestParamRegEx.test(item)) {
                ...
                if (_paramsResArrayTmp.length === 0) {
                  ...
                  var thead = !!((_opts$i18n2 = opts.i18n) !== null && _opts$i18n2 !== void 0 && _opts$i18n2.thead) ? opts.i18n.thead : opts.lang === "en-US" ? defaultI18nEn.thead : defaultI18nzhCN.thead;
                ...
                var optional = !!((_opts$i18n3 = opts.i18n) !== null && _opts$i18n3 !== void 0 && _opts$i18n3.thead) ? opts.i18n.optional : opts.lang === "en-US" ? defaultI18nEn.optional : defaultI18nzhCN.optional;
